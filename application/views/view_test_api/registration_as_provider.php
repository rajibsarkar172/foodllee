<div class="panel panel-primary"> 
	...
	<div class="panel-body">
		<form action="<?=$base_url.$active_controller.'/registration_as_provider'?>" method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="col-sm-6">
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
					...
					<input type="text" name="mobile" class="form-control" id="mobile" placeholder="Mobile e.g. 01702548936" value="<?=set_value("mobile")?>">
			...
			<div class="col-sm-6">
				<div class="form-group">
					...
					<input type="text" name="phone" class="form-control" id="phone" placeholder="Phone e.g. 0236547895" value="<?=set_value("phone")?>">
