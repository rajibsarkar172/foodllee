...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2017 at 12:25 PM
...
CREATE TABLE `service_locations` (
  ...
  `actual_location` varchar(100) CHARACTER SET latin1 NOT NULL,
...
(11, 'Kaligonj Upazila', 2, '2017-06-16', 2);
...
CREATE TABLE `users` (
  ...
  `usertype` enum('Admin','Provider','Receiver') CHARACTER SET latin1 NOT NULL,
  `mobile` varchar(14) CHARACTER SET latin1 NOT NULL,
  `phone` varchar(14) CHARACTER SET latin1 NOT NULL,
  `email` varchar(100) CHARACTER SET latin1 NOT NULL,
  `gender` enum('Male','Female','Other') CHARACTER SET latin1 NOT NULL,
  `dob` date NOT NULL,
  `general_address` varchar(250) CHARACTER SET latin1 NOT NULL,
  `thana_id` int(10) NOT NULL,
  `latitude` varchar(50) CHARACTER SET latin1 NOT NULL,
  `lognitude` varchar(50) CHARACTER SET latin1 NOT NULL,
  `credit_balance` float NOT NULL,
  `status` enum('Active','Inactive','Sucpend') CHARACTER SET latin1 NOT NULL DEFAULT 'Inactive',
  `profile_pic` varchar(100) CHARACTER SET latin1 NOT NULL,
  `thamb_nail` varchar(100) CHARACTER SET latin1 NOT NULL,
  `is_displayed` enum('Yes','No') CHARACTER SET latin1 NOT NULL,
  `created_at` date NOT NULL,
  `updated_at` date NOT NULL,
  `updated_by` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(4, 'rajibsarkar', '9d8962fa2a344ac3f223fdb76fbf94ce2fbe1f7918d4420789a3f6fb4fa0fc1959481f46e1e54799e1fab5505d139ee80a54', 'Rajib Sarkar', 'Provider', '01741083867', '0236547895', 'rajib.sarkar@atomapgroup.com', 'Male', '1993-06-15', 'Mohammadpur, Dhaka, Bangladesh', 11, '23.8018225', '90.366426', 0, 'Inactive', 'pic_1497592384.jpg', '', 'Yes', '2017-06-16', '2017-06-16', 0),
(5, 'rajib.sarkar1', '71622958ed387353101000d137933beb4e9364d298b77d0cdca71435e5e8bf08b647861255fb3440ce31df2b1fd74a77ce62', 'Sarkar Rajib', 'Provider', '01564892235', '0266559988', 'rajibsarkar172@gmail.com', 'Male', '2017-06-16', 'Savar Upazila, Bangladesh', 3, '23.8018225', '90.366426', 0, 'Inactive', 'pic_1497594423.jpg', '', 'Yes', '2017-06-16', '2017-06-16', 0);
